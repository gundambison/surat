		...
		<tr>
			...
			<td class="ctr">
				...
				<a href="<?php echo base_URL()?>index.php/admin/surat_keluar/edt/<?php echo $b->id?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Edit</a>
					...
					<a target='_blank' href="<?php echo base_URL()?>upload/surat_keluar/<?php echo $b->file?>" class="btn btn-success btn-sm" title="Edit Data"><i class="icon-edit icon-white"> </i> Buka</a>
				</div>	
				<?php } else { ?>
				<div class="btn-group">
