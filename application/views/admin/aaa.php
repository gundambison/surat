    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
         <span class="navbar-brand"><strong style="font-family: verdana;">SIDS</strong></span>
		...
		<li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-random icon-white"> </i>Surat <span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="themes">
			...
			<li><a href="http://192.168.1.20/surat/chat/" onclick="window.open(this.href, 'mywin',
'left=20,top=20,width=650,height=650,toolbar=1,resizable=0'); return false;" >Chat</a>
			</li>
		...
		<li class="dropdown">
          ...
          <ul class="nav navbar-nav navbar-right">
			<li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i class="icon-user icon-white"></i> Profil <span class="caret"></span></a>
              <ul class="dropdown-menu" aria-labelledby="themes">
    ...
    <div class="container">
	  ...
	  <div class="span12 well well-sm">
		<h4 style="font-weight: bold">Sistem Informasi Distribusi Surat Bea Cukai Bontang<!--a href="" target="_blank">Nur Akhwan<!/a--></a></h4>
