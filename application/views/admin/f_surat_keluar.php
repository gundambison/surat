...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Perihal</td><td><b><textarea tabindex="4" name="uraian" required style="width: 400px; height: 60px" class="form-control"><?php echo $uraian; ?></textarea></b></td></tr>	
