  ...
  <body style="">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <span class="navbar-brand"><strong style="font-family: verdana; margin-left: 310px; text-align: center">Sistem Informasi Distribusi Surat Bea Cukai Bontang</strong></span>
	...
	<div class="container-fluid" style="margin-top: 30px">
      ...
      <div class="row-fluid">
		...
		<center style="font-size: 11px"><b></b><b></b></center>
		</form>
		</div><!--/span-->
      </div><!--/row-->

    </div><!--/.fluid-container-->
	<center style="margin-top: -15px;">BY&copy; 
	<a href=""></a><br>
