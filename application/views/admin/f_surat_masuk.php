...
if (isset($datpil->id)||$mode !== "edt"){?>	
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Perihal</td><td><b><textarea name="uraian" tabindex="4" required style="width: 400px; height: 90px" class="form-control"><?php echo $uraian; ?></textarea></b></td></tr>		
		<tr><td width="20%">File Surat </td><td><b><input type="file" name="file_surat" tabindex="8" class="form-control" style="width: 200px"></b></td></tr>	
